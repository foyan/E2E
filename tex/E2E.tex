...
Beispielsweise möchte ein Service Provider, der Teile (oder das Ganze) seines Services wiederum von einem dritten Service Provider einkauft, diesen nicht offenlegen. Des weiteren möchte wohl keine der Signatory parties den Supporting parties mehr Kennzahlen als nötig offenlegen (vor allem keine Preise).
\item Bla
\end{description}
