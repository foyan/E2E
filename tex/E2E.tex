...
Forrester schlägt darum explizit die Implementierung der {\em Six-Sigma}-Methodik vor \cite{forrester:slaBestPractices, wiki:sixsigma}:
\begin{enumerate}
